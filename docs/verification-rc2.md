...
| Check | Result |
| --- | --- |
| Full development suite | 320 passed; only the optional semantic-model module skipped |
| Minimal environment, NumPy 1.26.3, approximate token counting | 301 passed, 3 optional checks skipped |
...
| MCP 1.30.0 compatibility | 79 focused API, MCP and task-runner tests passed, including the two-process demo |
